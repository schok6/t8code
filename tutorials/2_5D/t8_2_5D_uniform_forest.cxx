...
main (int argc, char **argv)
{
  ...
  const char prefix[BUFSIZ] = "t8_2_5D_UNIFORM_FOREST_TRI_LINE_2_3"; 
  const char prefix_highlight[BUFSIZ] = "t8_2_5D_UNIFORM_FOREST_TRI_LINE_2_3_HIGHLIGHT_Partition";
