...
/* Adapt a biforest according to our t8_2_5D_adapt_callback function in either horizontal or vertical direction. 
...
t8_2_5D_adapt_forest (t8_forest_t forest)
{
   ...
   *   direction     - If one a biforest is adapted in horizontal directions, if two a biforest is adapted in vertical direction.
   *                   For an isotropic forest direction must be set to zero.
   */
...
t8_2_5D_adapt_main (int argc, char **argv)
{
  ...
  /* Adapt the biforest. We can reuse the forest variable, since the new adapted
