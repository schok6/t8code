 ...
 */
static void
t8_2_5D_write_cmesh_vtk (t8_cmesh_t cmesh, const char *prefix)
{
 ...
 */
static void
t8_2_5D_destroy_cmesh (t8_cmesh_t cmesh)
{
...
main (int argc, char **argv)
{
  ...
  t8_global_productionf (" [2_5D] Hello, this is the example for the 2_5D scheme of t8code.\n");
  t8_global_productionf (" [2_5D] In this example we build a coarse mesh for two eclasses and output it to vtu files.\n");
  t8_global_productionf (" [2_5D] \n");
  ...
  t8_global_productionf (" [2_5D] Wrote coarse mesh to vtu files: %s*\n", prefix);
  t8_2_5D_destroy_cmesh (cmesh);
  t8_global_productionf (" [2_5D] Destroyed coarse mesh.\n");
