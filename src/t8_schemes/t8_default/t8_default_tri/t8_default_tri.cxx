...
int
t8_default_scheme_tri::element_get_level (const t8_element_t *elem, [[maybe_unused]] int dir) const
{
...
void
t8_default_scheme_tri::element_get_parent (const t8_element_t *elem, t8_element_t *parent, [[maybe_unused]] int dir) const
{
...
void
t8_default_scheme_tri::element_get_sibling (const t8_element_t *elem, int sibid, t8_element_t *sibling, int dir) const
{
  const t8_dtri_t *t = (const t8_dtri_t *) elem;
...
int
t8_default_scheme_tri::element_get_num_children ([[maybe_unused]] const t8_element_t *elem, [[maybe_unused]] int dir) const
{
  T8_ASSERT (element_is_valid (elem));
...
void
t8_default_scheme_tri::element_get_child (const t8_element_t *elem, int childid, t8_element_t *child, [[maybe_unused]] int dir) const
{
  const t8_dtri_t *t = (const t8_dtri_t *) elem;
...
int
t8_default_scheme_tri::element_get_ancestor_id (const t8_element_t *elem, int level, [[maybe_unused]] int dir) const
{
  return t8_dtri_ancestor_id ((t8_dtri_t *) elem, level);
}

int
t8_default_scheme_tri::elements_are_family (t8_element_t *const *fam, [[maybe_unused]] int dir) const
{
#if T8_ENABLE_DEBUG
  {
...
void
t8_default_scheme_tri::element_get_nca (const t8_element_t *elem1, const t8_element_t *elem2, t8_element_t *nca, [[maybe_unused]] int dir) const
{
...
int
t8_default_scheme_tri::element_face_get_child_face (const t8_element_t *elem, int face, int face_child, [[maybe_unused]] int dir) const
{
  T8_ASSERT (element_is_valid (elem));
  T8_ASSERT (0 <= face && face < T8_DTRI_FACES);
...
int
t8_default_scheme_tri::element_face_get_parent_face (const t8_element_t *elem, int face, [[maybe_unused]] int dir) const
{
  T8_ASSERT (0 <= face && face < T8_DTRI_FACES);
...
void
t8_default_scheme_tri::element_set_linear_id (t8_element_t *elem, std::vector<int>& levels, t8_linearidx_t id) const
{
  T8_ASSERT (element_is_valid (elem));
  T8_ASSERT (0 <= levels[0] && levels[0] <= T8_DTRI_MAXLEVEL);
  T8_ASSERT (id < ((t8_linearidx_t) 1) << (2 * levels[0]));
...
void
t8_default_scheme_tri::element_get_first_descendant (const t8_element_t *elem, t8_element_t *desc, std::vector<int>& levels) const
{
  T8_ASSERT (element_is_valid (elem));
...
void
t8_default_scheme_tri::element_get_last_descendant (const t8_element_t *elem, t8_element_t *desc, std::vector<int>& levels) const
{
  T8_ASSERT (element_is_valid (elem));
  T8_ASSERT (element_is_valid (desc));
  T8_ASSERT (0 <= levels[0] && levels[0] <= T8_DTRI_MAXLEVEL);
...
void
t8_default_scheme_tri::element_construct_successor (const t8_element_t *elem1, t8_element_t *elem2, [[maybe_unused]] int dir) const
{
  T8_ASSERT (element_is_valid (elem1));
  T8_ASSERT (element_is_valid (elem2));
