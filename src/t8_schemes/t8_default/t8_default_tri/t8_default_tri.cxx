...
void
t8_default_scheme_tri::element_get_parent (const t8_element_t *elem, t8_element_t *parent,
...
int
t8_default_scheme_tri::element_get_num_children ([[maybe_unused]] const t8_element_t *elem,
                                                 [[maybe_unused]] int dir) const
{
  T8_ASSERT (element_is_valid (elem));
...
void
t8_default_scheme_tri::element_get_children (const t8_element_t *elem, [[maybe_unused]] int length, t8_element_t *c[],
                                             [[maybe_unused]] int dir) const
{
  T8_ASSERT (element_is_valid (elem));
#if T8_ENABLE_DEBUG
