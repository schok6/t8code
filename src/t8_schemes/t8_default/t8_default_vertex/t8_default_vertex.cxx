...
void
t8_default_scheme_vertex_c::t8_element_set_linear_id (t8_element_t *elem, int level, t8_linearidx_t id, int dir) const
{
...
t8_linearidx_t
t8_default_scheme_vertex_c::t8_element_get_linear_id (const t8_element_t *elem, int level, int dir) const
{
  T8_ASSERT (t8_element_is_valid (elem));
  T8_ASSERT (0 <= level && level <= T8_DVERTEX_MAXLEVEL);
...
void
t8_default_scheme_vertex_c::t8_element_first_descendant (const t8_element_t *elem, t8_element_t *desc, int level, int dir) const
{
  T8_ASSERT (t8_element_is_valid (elem));
...
void
t8_default_scheme_vertex_c::t8_element_new (int length, t8_element_t **elem, int dir) const
{
...
void
t8_default_scheme_vertex_c::t8_element_set_type (t8_element_t *elem, int dir) const
{
  T8_ASSERT( "Not implemented." );
}

void
t8_default_scheme_vertex_c::t8_element_get_type (t8_element_t *elem) const
{
  T8_ASSERT( "Not implemented." );
}

int
t8_default_scheme_vertex_c::t8_element_get_variable (t8_element_t *elem, int var, int dir) const
{
  T8_ASSERT( "Not implemented." );
}
