...
int
t8_default_scheme_vertex_c::t8_element_level (const t8_element_t *elem, int dir) const
{
...
void
t8_default_scheme_vertex_c::t8_element_parent (const t8_element_t *elem, t8_element_t *parent, int dir) const
{
...
void
t8_default_scheme_vertex_c::t8_element_sibling (const t8_element_t *elem, int sibid, t8_element_t *sibling, int dir) const
{
  const t8_dvertex_t *v = (const t8_dvertex_t *) elem;
...
int
t8_default_scheme_vertex_c::t8_element_num_children (const t8_element_t *elem, int dir) const
{
  T8_ASSERT (t8_element_is_valid (elem));
...
void
t8_default_scheme_vertex_c::t8_element_child (const t8_element_t *elem, int childid, t8_element_t *child, int dir) const
{
  const t8_dvertex_t *v = (const t8_dvertex_t *) elem;
...
void
t8_default_scheme_vertex_c::t8_element_children (const t8_element_t *elem, int length, t8_element_t *c[], int dir) const
{
...
int
t8_default_scheme_vertex_c::t8_element_child_id (const t8_element_t *elem, int dir) const
{
  T8_ASSERT (t8_element_is_valid (elem));
...
int
t8_default_scheme_vertex_c::t8_element_ancestor_id (const t8_element_t *elem, int level, int dir) const
{
  return t8_dvertex_ancestor_id ((const t8_dvertex_t *) elem, level);
}

int
t8_default_scheme_vertex_c::t8_element_is_family (t8_element_t *const *fam, int dir) const
{
#ifdef T8_ENABLE_DEBUG
  int i;
  for (i = 0; i < T8_DVERTEX_CHILDREN; i++) {
...
void
t8_default_scheme_vertex_c::t8_element_set_linear_id (t8_element_t *elem, std::vector<int>& levels, t8_linearidx_t id) const
{
  T8_ASSERT (0 <= levels[0] && levels[0] <= T8_DVERTEX_MAXLEVEL);
  T8_ASSERT (0 <= id && id < ((t8_linearidx_t) 1) << 3 * levels[0]);
  T8_ASSERT (t8_element_is_valid (elem));

  t8_dvertex_init_linear_id ((t8_dvertex_t *) elem, levels[0], id);
}

t8_linearidx_t
t8_default_scheme_vertex_c::t8_element_get_linear_id (const t8_element_t *elem, std::vector<int>& levels) const
{
  T8_ASSERT (t8_element_is_valid (elem));
  T8_ASSERT (0 <= levels[0] && levels[0] <= T8_DVERTEX_MAXLEVEL);

  return t8_dvertex_linear_id ((const t8_dvertex_t *) elem, levels[0]);
}

void
t8_default_scheme_vertex_c::t8_element_first_descendant (const t8_element_t *elem, t8_element_t *desc, std::vector<int>& levels) const
{
  T8_ASSERT (t8_element_is_valid (elem));
  T8_ASSERT (t8_element_is_valid (desc));
  T8_ASSERT (0 <= levels[0] && levels[0] <= T8_DVERTEX_MAXLEVEL);
  t8_dvertex_first_descendant ((const t8_dvertex_t *) elem, (t8_dvertex_t *) desc, levels[0]);
}

void
t8_default_scheme_vertex_c::t8_element_last_descendant (const t8_element_t *elem, t8_element_t *desc, std::vector<int>& levels) const
{
  T8_ASSERT (t8_element_is_valid (elem));
  T8_ASSERT (t8_element_is_valid (desc));
  T8_ASSERT (0 <= levels[0] && levels[0] <= T8_DVERTEX_MAXLEVEL);
  t8_dvertex_last_descendant ((const t8_dvertex_t *) elem, (t8_dvertex_t *) desc, levels[0]);
}
...
int
t8_default_scheme_vertex_c::t8_element_get_variable (const t8_element_t *elem, int var, int dir) const
{
