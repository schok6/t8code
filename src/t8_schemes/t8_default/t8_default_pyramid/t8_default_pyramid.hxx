...
class t8_default_scheme_pyramid: public t8_default_scheme_common<t8_default_scheme_pyramid> {
  ...
  */
   ...
   * It is valid to call this function with elem = child.
     */
  void
  element_get_child (const t8_element_t *elem, const int childid, t8_element_t *child, int dir) const;
   ...
   */
  int
  element_get_ancestor_id (const t8_element_t *elem, const int level, int dir) const;
   ...
   */
  t8_gloidx_t
  element_count_leaves (const t8_element_t *t, const int level, int dir) const;
   ...
   */
  int
  element_face_get_child_face (const t8_element_t *elem, const int face, const int face_child, int dir) const;
   ...
   */
  int
  element_face_get_parent_face (const t8_element_t *elem, const int face, int dir) const;
