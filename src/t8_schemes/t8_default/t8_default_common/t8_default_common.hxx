...
class t8_default_scheme_common_c: public t8_eclass_scheme_c {
 public:
  ...
  virtual void
  t8_element_new (int length, t8_element_t **elem, int dir = 0) const override;

  /** Deallocate space for a bunch of elements. */
  virtual void
  t8_element_destroy (int length, t8_element_t **elem, int dir = 0) const override;

  /** Return the shape of an element */
  virtual t8_element_shape_t
  t8_element_shape (const t8_element_t *elem, int dir = 0) const override;
   ...
   */
  virtual t8_gloidx_t
  t8_element_count_leaves (const t8_element_t *t, int level, int dir = 0) const override; 
   ...
   */
  virtual int
  t8_element_num_siblings (const t8_element_t *elem, int dir = 0) const override;
   ...
   */
  t8_gloidx_t
  t8_element_count_leaves_from_root (int level, int dir = 0) const override;
