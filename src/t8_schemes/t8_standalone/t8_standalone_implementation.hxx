...
struct t8_standalone_scheme
{
  ...
  */
   ...
   */
  static constexpr int
  element_get_level (const t8_element_t *elem, [[maybe_unused]] int dir = 0) noexcept
  {
    T8_ASSERT (element_is_valid (elem));
   ...
   * no face of the parent matches the face.
    ...
    */
  static constexpr int
  element_face_get_parent_face ([[maybe_unused]] const t8_element_t *elem, [[maybe_unused]] const int face, [[maybe_unused]] int dir) noexcept
  {
    SC_ABORT ("This function is not implemented in this scheme yet.\n");
    return 0;
  }
  ...
  element_get_first_descendant_face ([[maybe_unused]] const t8_element_t *elem, [[maybe_unused]] const int face,
                                     ...
                                     [[maybe_unused]] const t8_element_level level, [[maybe_unused]] int dir) noexcept
  {
    SC_ABORT ("This function is not implemented in this scheme yet.\n");
  }
  ...
  element_extrude_face ([[maybe_unused]] const t8_element_t *face, [[maybe_unused]] t8_element_t *elem,
                        [[maybe_unused]] const int root_face, [[maybe_unused]] const t8_scheme *face_scheme, [[maybe_unused]] int dir = 0) noexcept
  {
    SC_ABORT ("This function is not implemented in this scheme yet.\n");
    return 0;
  }
