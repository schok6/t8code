                        ...
                        [[maybe_unused]] const int num_elements, t8_element_t *elements[])
{
  ...
  * gradients larger than average are refined and gradients smaller are coarsened. */
  ...
  t8_locidx_t elems = t8_forest_get_local_num_leaf_elements (forest_from);
  ...
  t8_linearidx_t lin_id = scheme_mixed->element_get_linear_id (tree_class, elements[0], levels);
  ...
  if (lelement_id + (which_tree * elems_tree1) + 1 < elems_help) {
    ...
    successor1[0] = t8_forest_get_leaf_element (forest_from, lelement_id + (which_tree * elems_tree1) + 1, &tree_succ1);
    lin_id2 = scheme_mixed->element_get_linear_id (tree_class, successor1[0], levels);
  ...
  if (is_family) {
    if (lelement_id + (which_tree * elems_tree1) + 2 < elems_help) {
      ...
      successor2[0]
        = t8_forest_get_leaf_element (forest_from, lelement_id + (which_tree * elems_tree1) + 2, &tree_succ2);
      lin_id3 = scheme_mixed->element_get_linear_id (tree_class, successor2[0], levels);
  ...
  else if (is_family && gradient1 < adapt_data->coarsen_if_less_than_10perc
           && gradient2 < adapt_data->coarsen_if_less_than_10perc) {
...
t8_2_5D_output_data_to_vtu_example (t8_forest_t forest, struct MESSy_data_per_element *data, const char *prefix,
                                    double *gradient, int level1, int level2)
{
  t8_tree_t tree;
  t8_locidx_t itree;
  ...
  for (itree = 0; itree < num_global_trees; itree++) {
    ...
    if (itree < num_local_trees) {
      ...
      for (element_index = 0; element_index < element_index_in_tree; element_index++, column_check++) {
        ...
        lin_id = scheme_mixed->element_get_linear_id (tree_class, element, levels);
...
main (int argc, char **argv)
{
  ...
  t8_global_productionf (
    "(x,y,z) = (%i,%i,%i) & (x_check, y_check, z_check) = (%i,%i,%i) & (x_lev, y_lev, z_lev) = (%i,%i,%i) \n", x, y, z,
    x_check, y_check, z_check, x_lev, y_lev, z_lev);
        ...
        for (int y_val = 0; y_val < quadlength; y_val++) {
          if (get_morton_index (x_val, y_val, level1) == check) {
            ...
            if (latlength > lonlength) {
              get_values_for_column_xy (x_val, y_val + pow (2, level1) * cmesh, level1, levlength, levlength, latlength,
                                        lonlength, tm_1, tm_1_sort_90 + pos);
              get_values_for_column_xy (x_val, y_val + pow (2, level1) * cmesh, level1, levlength, levlength, latlength,
                                        lonlength, geopot, geopot_sort_90 + pos);
            }
            else if (latlength < lonlength) {
              get_values_for_column_xy (x_val + pow (2, level1) * cmesh, y_val, level1, levlength, levlength, latlength,
                                        lonlength, tm_1, tm_1_sort_90 + pos);
              get_values_for_column_xy (x_val + pow (2, level1) * cmesh, y_val, level1, levlength, levlength, latlength,
                                        lonlength, geopot, geopot_sort_90 + pos);
            }
            else if (latlength == lonlength) {
              get_values_for_column_xy (x_val, y_val, level1, levlength, levlength, latlength, lonlength, tm_1,
                                        tm_1_sort_90 + pos);
              get_values_for_column_xy (x_val, y_val, level1, levlength, levlength, latlength, lonlength, geopot,
                                        geopot_sort_90 + pos);
            }
  ...
  */
  ...
  struct MESSy_data_per_element data = { height_sort_90, tm_1_sort_90, temp_grad_sort_90, elems_per_column };
  ...
  //num_elements = t8_forest_get_global_num_leaf_elements (forest);

  float coarsen;
  float refine;
  float percentage1 = 0.05;
  float percentage2 = 0.05;
  ...
  struct MESSy_data adapt_data = { tm_1_sort_90, height_sort_90, refine, coarsen, level1, elems_per_column };
  ...
  struct MESSy_data_per_element data_adapt_element
    = { height_sort_90, tm_1_sort_90, temp_grad_sort_90, elems_per_column };

  t8_2_5D_output_data_to_vtu_example (forest, &data_adapt_element, prefix_forest_with_data_adapt, gradient, level1,
                                      level2);
  ...
  struct MESSy_data adapt_data1 = { tm_1_sort_90, height_sort_90, refine, coarsen, level1, elems_per_column };
  ...
  t8_2_5D_output_data_to_vtu_example (forest, &data_adapt_element1, prefix_forest_with_data_adapt1, gradient, level1,
                                      level2);
  ...
  struct MESSy_data adapt_data2 = { tm_1_sort_90, height_sort_90, refine, coarsen, level1, elems_per_column };
  ...
  t8_2_5D_output_data_to_vtu_example (forest, &data_adapt_element2, prefix_forest_with_data_adapt2, gradient, level1,
                                      level2);
  ...
  struct MESSy_data adapt_data3 = { tm_1_sort_90, height_sort_90, refine, coarsen, level1, elems_per_column };
  ...
  t8_2_5D_output_data_to_vtu_example (forest, &data_adapt_element3, prefix_forest_with_data_adapt3, gradient, level1,
                                      level2);
  ...
  struct MESSy_data adapt_data4 = { tm_1_sort_90, height_sort_90, refine, coarsen, level1, elems_per_column };
  ...
  t8_2_5D_output_data_to_vtu_example (forest, &data_adapt_element4, prefix_forest_with_data_adapt4, gradient, level1,
                                      level2);
  ...
  struct MESSy_data adapt_data5 = { tm_1_sort_90, height_sort_90, refine, coarsen, level1, elems_per_column };
  ...
  struct MESSy_data adapt_data6 = { tm_1_sort_90, height_sort_90, refine, coarsen, level1, elems_per_column };
  ...
  t8_2_5D_output_data_to_vtu_example (forest, &data_adapt_element4, prefix_forest_with_data_adapt5, gradient, level1,
                                      level2);
